...
router.get("/documentsProfView",function(req,res){
    if (req.session.loggedin) {
        
        db.query('SELECT files.* FROM files JOIN faculty ON faculty.id =?',[req.session.username] , function(error, result){
            ...
            res.render("documentsProfView",{json:JSON.parse(JSON.stringify(result))});
